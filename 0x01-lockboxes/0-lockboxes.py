#!/usr/bin/python3
"""
The module provides a function for determining if all boxes in a
      given list can be opened.
"""


def canUnlockAll(boxes):
    """
    The function takes a list of lists and returns a boolean indicating
